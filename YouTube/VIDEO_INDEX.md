# Go Happy Belly — YouTube Video Board

> Quick reference for every video idea, so you can look up any ID at a glance.
...
**Challenge videos:** YT-002, YT-007, YT-013, YT-015 are personal-experiment videos (Alina runs the challenge and films BTS across the full window). They need lead time, so they are not immediate/first shoots.
...
## Shoot-now first batch (P1, pure solo teach, no waiting)
...
| ID | Title | Pri | Status | Modeled on (Ben Azadi video, real views) |
|----|-------|-----|--------|-------------------------------------------|
| YT-001 | 5 "Health" Foods Quietly Wrecking Your Digestion | P2 | idea | 36 Shocking Foods RFK Jr Just Banned (4M) |
| YT-002 | What Happens If You Cut Sugar For 14 Days | P1 | packaged | What Happens If You ONLY Drink Water For 72 Hours? (2.3M) |
| YT-003 | 5 Ways to Stop the 3PM Energy Crash | P2 | idea | I Reversed My Insulin Resistance Fast, Try These 5 Things (2.3M) |
| YT-004 | What Happens When You Give Your Gut a Full Day Off Food | P2 | idea | What Happens When You Stop Eating For 36 Hours (2.6M) |
| YT-005 | The Uncomfortable Truth About Stress and Bloating Nobody Tells You | P1 | packaged | The Uncomfortable Truth About Cortisol & Insulin (1.6M) |
| YT-006 | 9 Everyday Foods That Might Be Working Against Your Gut | P3 | idea | WTF Happened to Our Food! RFK Jr Wants These 9 Foods BANNED (1.6M) |
...
| YT-020 | FDA Recall: What It Means for Your Gut | P3 | idea | BREAKING: The FDA Just Recalled These Lettuce Products (574K) *(waiting on a real current headline)* |

---

### Notes
- **P1** = first batch, **P2** = soon, **P3** = parking lot (waiting on a real news headline).
- The two P3s (YT-006, YT-020) are news-jacking ideas held until a real, current food-policy or recall story exists to anchor them.
- YT-019 needs a real, consented client number before it gets scripted (never an invented statistic).
- To build a full package for any idea, just tell me the ID (for example, "package YT-012") and I will produce its script, thumbnail brief, repurposing plan, and PDF.
